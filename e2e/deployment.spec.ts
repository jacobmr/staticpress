...
test.describe("Deployment Page", () => {
  test("should redirect unauthenticated users from deploy page", async ({
    page,
  }) => {
    ...
    await expect(page)
      .not.toHaveURL(/.*deploy.*/, { timeout: 5000 })
      .catch(() => {
  ...
  test("should display platform options for authenticated users", async ({
    page,
  }) => {
  ...
  test("should have correct page structure elements", async ({ page }) => {
    ...
    if (url.includes("/deploy")) {
      ...
      await expect(
        page.getByRole("heading", { name: /deploy your blog/i }),
      ).toBeVisible();
...
test.describe("Deployment API - Platform Management", () => {
  test("GET /api/deployment/platforms should require authentication", async ({
    request,
  }) => {
  ...
  test("POST /api/deployment/platforms with invalid platform should return 400 or 401", async ({
    request,
  }) => {
  ...
  test("POST /api/deployment/platforms with missing fields should return 400 or 401", async ({
    request,
  }) => {
    const response = await request.post("/api/deployment/platforms", {
      data: {
  ...
  test("POST /api/deployment/platforms with empty data should return error", async ({
    request,
  }) => {
    const response = await request.post("/api/deployment/platforms", {
      data: {},
...
test.describe("Deployment API - Project Management", () => {
  test("GET /api/deployment/projects should require authentication", async ({
    request,
  }) => {
  ...
  test("POST /api/deployment/projects with missing fields should return 400 or 401", async ({
    request,
  }) => {
  ...
  test("POST /api/deployment/projects with invalid platform should return error", async ({
    request,
  }) => {
    const response = await request.post("/api/deployment/projects", {
      data: {
  ...
  test("POST /api/deployment/projects with empty name should return error", async ({
    request,
  }) => {
    const response = await request.post("/api/deployment/projects", {
      data: {
...
test.describe("Deployment API - Deploy Endpoint", () => {
  test("POST /api/deployment/projects/[id]/deploy without auth should return 401", async ({
    request,
  }) => {
    const response = await request.post(
      "/api/deployment/projects/test-project-id/deploy",
      {
        data: {
          branch: "main",
          isProduction: true,
  ...
  test("POST /api/deployment/projects/[id]/deploy with missing body should return error", async ({
    request,
  }) => {
    const response = await request.post(
      "/api/deployment/projects/test-project-id/deploy",
  ...
  test("POST /api/deployment/projects with non-existent project should return error", async ({
    request,
  }) => {
    const response = await request.post(
      "/api/deployment/projects/non-existent-id-12345/deploy",
      {
        data: {
          branch: "main",
          isProduction: true,
...
test.describe("Deployment API - Status Endpoint", () => {
  test("GET /api/deployment/projects/[id]/status without auth should return 401", async ({
    request,
  }) => {
    const response = await request.get(
      "/api/deployment/projects/test-project-id/status",
    );
  ...
  test("GET /api/deployment/projects/[id]/status with invalid ID should return error", async ({
    request,
  }) => {
    const response = await request.get(
      "/api/deployment/projects/invalid-uuid-format/status",
    );
  ...
  test("GET /api/deployment/projects/[id]/status with random UUID should return error", async ({
    request,
  }) => {
    // Use a properly formatted UUID that doesn't exist
    const response = await request.get(
      "/api/deployment/projects/12345678-1234-1234-1234-123456789012/status",
    );
...
test.describe("Deployment API - OAuth Flow", () => {
  test("GET /api/deployment/oauth/vercel should require authentication", async ({
    request,
  }) => {
  ...
  test("GET /api/deployment/oauth/netlify should require authentication", async ({
    request,
  }) => {
  ...
  test("GET /api/deployment/oauth/cloudflare should require authentication", async ({
    request,
  }) => {
  ...
  test("GET /api/deployment/oauth/github-pages should return error (uses existing auth)", async ({
    request,
  }) => {
  ...
  test("GET /api/deployment/oauth/invalid-platform should return error", async ({
    request,
  }) => {
    const response = await request.get(
      "/api/deployment/oauth/invalid-platform",
    );
  ...
  test("OAuth callback without code should redirect with error", async ({
    page,
  }) => {
  ...
  test("OAuth callback without state should redirect with error", async ({
    page,
  }) => {
  ...
  test("OAuth callback with error parameter should redirect with error", async ({
    page,
  }) => {
    await page.goto(
      "/api/deployment/oauth/vercel/callback?error=access_denied&error_description=User%20denied%20access",
    );
...
test.describe("Deployment API - Platform-specific Routes", () => {
  test("GET /api/deployment/platforms/vercel should require authentication", async ({
    request,
  }) => {
  ...
  test("DELETE /api/deployment/platforms/vercel should require authentication", async ({
    request,
  }) => {
...
test.describe("Deployment API - Project Domains", () => {
  test("GET /api/deployment/projects/[id]/domains without auth should return 401", async ({
    request,
  }) => {
    const response = await request.get(
      "/api/deployment/projects/test-project-id/domains",
    );
  ...
  test("POST /api/deployment/projects/[id]/domains without auth should return 401", async ({
    request,
  }) => {
    const response = await request.post(
      "/api/deployment/projects/test-project-id/domains",
...
test.describe("Deployment API - Project Logs", () => {
  test("GET /api/deployment/projects/[id]/logs without auth should return 401", async ({
    request,
  }) => {
    const response = await request.get(
      "/api/deployment/projects/test-project-id/logs",
    );
...
test.describe("Platform UI Elements", () => {
  test("should show all four platforms on deploy page when authenticated", async ({
    page,
  }) => {
    await page.goto("/deploy");
  ...
  test("should have external links for platform documentation", async ({
    page,
  }) => {
    await page.goto("/deploy");
    ...
    if (url.includes("/deploy")) {
      ...
      const cloudflareLink = page.getByRole("link", {
        name: /deploy to cloudflare/i,
      });
      const vercelLink = page.getByRole("link", { name: /deploy to vercel/i });
      const netlifyLink = page.getByRole("link", {
        name: /deploy to netlify/i,
      });
...
test.describe("API Response Format", () => {
  test("platform API should return proper JSON structure", async ({
    request,
  }) => {
    const response = await request.get("/api/deployment/platforms");
  ...
  test("projects API should return proper JSON structure", async ({
    request,
  }) => {
    const response = await request.get("/api/deployment/projects");
  ...
  test("deploy API should return proper error JSON structure", async ({
    request,
  }) => {
    const response = await request.post(
      "/api/deployment/projects/test-id/deploy",
      {
        data: { branch: "main" },
      },
    );
  ...
  test("status API should return proper JSON structure", async ({
    request,
  }) => {
    const response = await request.get(
      "/api/deployment/projects/test-id/status",
    );
...
test.describe("Edge Cases and Error Handling", () => {
  ...
  test("should handle special characters in project ID", async ({
    ...
    const response = await request.get(
      `/api/deployment/projects/${encodeURIComponent(specialId)}/status`,
    );
