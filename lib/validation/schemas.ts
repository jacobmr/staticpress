...
export const uploadImageSchema = z.object({
  ...
  contentType: z
    .string()
    .regex(/^image\/(jpeg|png|gif|webp|svg\+xml)$/, "Invalid image type"),
});
...
export const faviconUploadSchema = z.object({
  ...
  contentType: z
    .string()
    .regex(
      /^image\/(png|x-icon|vnd.microsoft.icon|svg\+xml)$/,
...
export type CreateDeploymentProjectInput = z.infer<
  typeof createDeploymentProjectSchema
>;
