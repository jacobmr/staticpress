...
export function DeploymentManager({
  ...
  const [platformToConnect, setPlatformToConnect] =
    useState<Platform>("github-pages");
    ...
    try {
      ...
      if (statusRes.ok) {
        ...
        if (data.status) {
          ...
          setCurrentPlatform(
            (data.status.provider as Platform) || "github-pages",
          );
        }
      }
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="mt-1 text-sm text-green-700 dark:text-green-300">
                Your site is now connected to{" "}
                {setupPlatform === "github-pages"
                  ? "GitHub Pages"
                  : setupPlatform?.charAt(0).toUpperCase() +
                    (setupPlatform?.slice(1) || "")}
      ...
      <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                    ...
                    <button
                      onClick={() =>
                        setShowDnsInstructions(
                          showDnsInstructions === domain.domain
                            ? null
                            : domain.domain,
                        )
                      }
        ...
        {showDnsInstructions && (
          <div className="mb-4 rounded-md bg-blue-50 p-4 dark:bg-blue-900/20">
            ...
            {domains.find((d) => d.domain === showDnsInstructions)
              ?.verificationRecord && (
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        onClick={() =>
                          copyDnsRecord(
                            domains.find(
                              (d) => d.domain === showDnsInstructions,
                            )?.verificationRecord?.value || "",
                          )
                        }
            ...
            <p className="mt-3 text-xs text-blue-700 dark:text-blue-300">
              ...
              automatically verify once the record is detected.
            </p>
          </div>
        )}
