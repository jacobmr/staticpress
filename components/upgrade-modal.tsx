...
export function UpgradeModal({
  ...
  const reasonMessages = {
    post_limit: {
      ...
      description:
        "Free tier is limited to editing your 5 most recent posts. Upgrade to Personal to edit all posts.",
    },
    images: {
    ...
    themes: {
      ...
      description:
        "Access to premium themes is available on SMB tier and above.",
    },
  };
