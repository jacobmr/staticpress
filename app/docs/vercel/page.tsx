      ...
      <main className="flex-1 overflow-y-auto">
        <div className="container mx-auto max-w-4xl px-4 py-12">
          ...
          <p className="mb-8 text-lg text-gray-600 dark:text-gray-400">
            Deploy your Hugo blog to Vercel&apos;s edge network with preview
          ...
          <section id="oauth-connection" className="mb-12">
            ...
            <div className="prose dark:prose-invert max-w-none">
              <p className="mb-4 text-gray-600 dark:text-gray-400">
                StaticPress uses OAuth to securely connect to your Vercel
                account without storing credentials:
              </p>
              ...
              <ol className="mb-6 list-decimal space-y-4 pl-6 text-gray-600 dark:text-gray-400">
                ...
                <li>
                  ...
                  <p className="mt-1">
                    You&apos;ll be redirected to Vercel&apos;s authorization
                    page.
                  </p>
                </li>
                <li>
                  ...
                  <p className="mt-1">
                    Review the permissions and click &quot;Authorize&quot; to
                    grant access.
                  </p>
                </li>
                <li>
                  ...
                  <p className="mt-1">
                    You&apos;ll be redirected back with Vercel connected to your
                    account.
                  </p>
                </li>
              </ol>
              ...
              <div className="my-6 rounded-lg border-2 border-dashed border-gray-300 bg-gray-100 p-8 text-center dark:border-gray-700 dark:bg-gray-800">
                <div className="text-gray-500 dark:text-gray-400">
                  ...
                  <p className="text-sm">
                    Screenshot: Vercel OAuth authorization screen
                  </p>
                </div>
              </div>
              ...
              <div className="rounded-lg border border-blue-200 bg-blue-50 p-4 dark:border-blue-900 dark:bg-blue-900/20">
                <p className="text-sm text-blue-800 dark:text-blue-200">
                  ...
                  permission to create projects, manage deployments, and
                  configure domains on your behalf.
                </p>
              </div>
            </div>
          </section>
          ...
          <section id="auto-creation" className="mb-12">
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <ul className="mb-4 list-disc space-y-2 pl-6 text-gray-600 dark:text-gray-400">
                ...
                <li>
                  <strong>Git Integration:</strong> Automatic deployments on
                  push to main branch
                </li>
                <li>
                  <strong>Preview URLs:</strong> Unique URL for each pull
                  request
                </li>
              </ul>
              ...
              <div className="my-6 rounded-lg border-2 border-dashed border-gray-300 bg-gray-100 p-8 text-center dark:border-gray-700 dark:bg-gray-800">
                <div className="text-gray-500 dark:text-gray-400">
                  ...
                  <p className="text-sm">
                    Screenshot: Vercel dashboard showing newly created Hugo
                    project
                  </p>
                </div>
              </div>
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <ol className="mb-6 list-decimal space-y-4 pl-6 text-gray-600 dark:text-gray-400">
                <li>
                  ...
                  <p className="mt-1">
                    In Vercel dashboard, navigate to your project &gt; Settings
                    &gt; Domains
                  </p>
                </li>
                <li>
              ...
              <div className="my-6 rounded-lg border-2 border-dashed border-gray-300 bg-gray-100 p-8 text-center dark:border-gray-700 dark:bg-gray-800">
                <div className="text-gray-500 dark:text-gray-400">
                  ...
                  <p className="text-sm">
                    Screenshot: Vercel domains settings with DNS configuration
                  </p>
                </div>
              </div>
            </div>
          ...
          <section id="environment-variables" className="mb-12">
            ...
            <div className="prose dark:prose-invert max-w-none">
              <p className="mb-4 text-gray-600 dark:text-gray-400">
                For most Hugo sites, environment variables are not required.
                However, if your theme needs them:
              </p>
                ...
                <table className="min-w-full text-sm">
                  ...
                  <tbody className="text-gray-600 dark:text-gray-400">
                    <tr>
                      ...
                      <td className="border-t border-gray-200 px-4 py-2 dark:border-gray-700">
                        Specify Hugo version (e.g., 0.120.0)
                      </td>
                    </tr>
                    <tr>
                      <td className="border-t border-gray-200 px-4 py-2 dark:border-gray-700">
          ...
          <section id="preview-deployments" className="mb-12">
            ...
            <div className="prose dark:prose-invert max-w-none">
              <p className="mb-4 text-gray-600 dark:text-gray-400">
                One of Vercel&apos;s most powerful features is automatic preview
                deployments:
              </p>
              ...
              <ul className="mb-4 list-disc space-y-2 pl-6 text-gray-600 dark:text-gray-400">
                <li>
                  Every push to a non-production branch creates a unique preview
                  URL
                </li>
                <li>
                  Pull requests automatically get preview comments with
                  deployment links
                </li>
              ...
              <div className="my-6 rounded-lg border-2 border-dashed border-gray-300 bg-gray-100 p-8 text-center dark:border-gray-700 dark:bg-gray-800">
                <div className="text-gray-500 dark:text-gray-400">
                  ...
                  <p className="text-sm">
                    Screenshot: GitHub PR comment showing Vercel preview
                    deployment link
                  </p>
                </div>
              </div>
            ...
            <div className="space-y-6">
              <div>
                ...
                <ul className="list-disc space-y-1 pl-6 text-sm text-gray-600 dark:text-gray-400">
                  <li>
                    Ensure your project framework is set to &quot;Hugo&quot; in
                    project settings
                  </li>
                  <li>
                    Try setting{" "}
