      ...
      <main className="flex-1 overflow-y-auto">
        <div className="container mx-auto max-w-4xl px-4 py-12">
          ...
          <p className="mb-8 text-lg text-gray-600 dark:text-gray-400">
            Choose your preferred hosting platform and follow our step-by-step
            guides to deploy your Hugo blog.
          </p>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            >
              ...
              <p className="mb-4 text-gray-600 dark:text-gray-400">
                Free hosting directly from your GitHub repository. One-click
                setup with automatic deployments.
              </p>
            ...
            >
              ...
              <p className="mb-4 text-gray-600 dark:text-gray-400">
                Edge network deployment with preview builds for every push.
                Great for teams.
              </p>
              <ul className="space-y-1 text-sm text-gray-500 dark:text-gray-500">
            ...
            >
              ...
              <p className="mb-4 text-gray-600 dark:text-gray-400">
                Powerful build system with forms, functions, and split testing
                built-in.
              </p>
              <ul className="space-y-1 text-sm text-gray-500 dark:text-gray-500">
          ...
          <div className="mt-12 rounded-lg border border-gray-200 bg-gray-50 p-6 dark:border-gray-800 dark:bg-gray-900">
            ...
            <p className="mb-4 text-gray-600 dark:text-gray-400">
              Not sure which platform is right for you? Here&apos;s a quick
              guide:
            </p>
            <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
              <li>
                <strong>GitHub Pages</strong> - Best for simplicity and staying
                within GitHub ecosystem
              </li>
              <li>
                <strong>Vercel</strong> - Best for teams needing preview
                deployments
              </li>
              <li>
                <strong>Netlify</strong> - Best for additional features like
                forms and functions
              </li>
              <li>
                <strong>Cloudflare Pages</strong> - Best for performance and if
