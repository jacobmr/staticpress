      ...
      <main className="flex-1 overflow-y-auto">
        <div className="container mx-auto max-w-4xl px-4 py-12">
          ...
          <p className="mb-8 text-lg text-gray-600 dark:text-gray-400">
            Deploy your Hugo blog for free using GitHub Pages with one-click
            setup.
          </p>
          ...
          <section id="one-click-setup" className="mb-12">
            ...
            <div className="prose dark:prose-invert max-w-none">
              <p className="mb-4 text-gray-600 dark:text-gray-400">
                StaticPress makes deploying to GitHub Pages incredibly simple.
              ...
              <ol className="mb-6 list-decimal space-y-4 pl-6 text-gray-600 dark:text-gray-400">
                ...
                <li>
                  ...
                  <p className="mt-1">
                    Click the one-click deploy button for GitHub Pages.
                  </p>
                </li>
                <li>
                  <strong>Wait for Deployment</strong>
                  <p className="mt-1">
                    StaticPress automatically configures your repository with a
                    GitHub Actions workflow and enables GitHub Pages.
                  </p>
                </li>
                <li>
              ...
              <div className="my-6 rounded-lg border-2 border-dashed border-gray-300 bg-gray-100 p-8 text-center dark:border-gray-700 dark:bg-gray-800">
                <div className="text-gray-500 dark:text-gray-400">
                  ...
                  <p className="text-sm">
                    Screenshot: StaticPress Deploy page showing GitHub Pages
                    one-click button
                  </p>
                </div>
              </div>
          ...
          <section id="how-it-works" className="mb-12">
            ...
            <div className="prose dark:prose-invert max-w-none">
              <p className="mb-4 text-gray-600 dark:text-gray-400">
                When you enable GitHub Pages through StaticPress, we set up
                automatic deployments using GitHub Actions:
              </p>

              <ol className="mb-6 list-decimal space-y-3 pl-6 text-gray-600 dark:text-gray-400">
                <li>
                  A GitHub Actions workflow file is created at{" "}
                  <code className="rounded bg-gray-200 px-1 dark:bg-gray-700">
                    .github/workflows/hugo.yml
                  </code>
                </li>
                <li>
                  GitHub Pages is enabled with &quot;GitHub Actions&quot; as the
                  source
                </li>
                <li>
                  Every time you publish a post, the workflow automatically:
              ...
              <p className="mb-4 text-gray-600 dark:text-gray-400">
                You can monitor your deployment status directly in StaticPress.
                The dashboard shows:
              </p>
              <ul className="mb-4 list-disc space-y-2 pl-6 text-gray-600 dark:text-gray-400">
                <li>
                  <strong>Pending</strong> - Deployment is in progress
                </li>
                <li>
                  <strong>Success</strong> - Site is live and accessible
                </li>
                <li>
                  <strong>Failed</strong> - Something went wrong (check logs)
                </li>
              </ul>
              ...
              <div className="my-6 rounded-lg border-2 border-dashed border-gray-300 bg-gray-100 p-8 text-center dark:border-gray-700 dark:bg-gray-800">
                <div className="text-gray-500 dark:text-gray-400">
                  ...
                  <p className="text-sm">
                    Screenshot: Deployment status indicator showing build
                    progress
                  </p>
                </div>
              </div>
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <ol className="mb-6 list-decimal space-y-4 pl-6 text-gray-600 dark:text-gray-400">
                <li>
                  ...
                  <p className="mt-1">
                    On GitHub, navigate to your repository &gt; Settings &gt;
                    Pages
                  </p>
                </li>
                <li>
                ...
                <li>
                  ...
                  <p className="mt-1">
                    Check &quot;Enforce HTTPS&quot; (may take a few minutes to
                ...
                <li>
                  ...
                  <p className="mt-1">
                    Update your DNS records (see section below)
                  </p>
                </li>
              </ol>
              ...
              <div className="my-6 rounded-lg border-2 border-dashed border-gray-300 bg-gray-100 p-8 text-center dark:border-gray-700 dark:bg-gray-800">
                <div className="text-gray-500 dark:text-gray-400">
                  ...
                  <p className="text-sm">
                    Screenshot: GitHub Pages settings showing custom domain
                    field
                  </p>
                </div>
              </div>
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <div className="rounded-lg border border-yellow-200 bg-yellow-50 p-4 dark:border-yellow-900 dark:bg-yellow-900/20">
                <p className="text-sm text-yellow-800 dark:text-yellow-200">
                  ...
                  to propagate, though they usually take effect within a few
            ...
            <div className="space-y-6">
              <div>
                ...
                <ul className="list-disc space-y-1 pl-6 text-sm text-gray-600 dark:text-gray-400">
                  <li>
                    View the deployment logs in StaticPress for error details
                  </li>
                  <li>
                    Ensure your Hugo theme is properly installed as a git
                    submodule
                  </li>
                  <li>
                    Check that your{" "}
              ...
              <div>
                ...
                <ul className="list-disc space-y-1 pl-6 text-sm text-gray-600 dark:text-gray-400">
                  <li>
                    ...
                    to match your deployment URL exactly
                  </li>
                  <li>
                    Ensure you&apos;re using HTTPS if that&apos;s your
                    deployment URL
                  </li>
