      ...
      <main className="flex-1 overflow-y-auto">
        <div className="container mx-auto max-w-4xl px-4 py-12">
          ...
          <p className="mb-8 text-lg text-gray-600 dark:text-gray-400">
            Deploy your Hugo blog to Cloudflare&apos;s global edge network with
            integrated DNS and DDoS protection.
          </p>
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <ol className="mb-6 list-decimal space-y-4 pl-6 text-gray-600 dark:text-gray-400">
                <li>
                  ...
                  <p className="mt-1">
                    Go to Settings &gt; Deploy in your StaticPress dashboard.
                  </p>
                </li>
                <li>
                  <strong>Click &quot;Connect Cloudflare&quot;</strong>
                  <p className="mt-1">
                    You&apos;ll be redirected to Cloudflare&apos;s authorization
                    page.
                  </p>
                </li>
                <li>
                ...
                <li>
                  ...
                  <p className="mt-1">
                    You&apos;ll be redirected back with Cloudflare connected.
                  </p>
                </li>
              </ol>
              ...
              <div className="my-6 rounded-lg border-2 border-dashed border-gray-300 bg-gray-100 p-8 text-center dark:border-gray-700 dark:bg-gray-800">
                <div className="text-gray-500 dark:text-gray-400">
                  ...
                  <p className="text-sm">
                    Screenshot: Cloudflare OAuth authorization screen
                  </p>
                </div>
              </div>
              ...
              <div className="rounded-lg border border-blue-200 bg-blue-50 p-4 dark:border-blue-900 dark:bg-blue-900/20">
                <p className="text-sm text-blue-800 dark:text-blue-200">
                  <strong>Permissions Requested:</strong> StaticPress requests
                  permission to create Pages projects, manage deployments, and
          ...
          <section id="auto-creation" className="mb-12">
            <h2 className="mb-4 text-2xl font-bold">
              How Projects Are Auto-Created
            </h2>
            <div className="prose dark:prose-invert max-w-none">
              <p className="mb-4 text-gray-600 dark:text-gray-400">
                Once connected, StaticPress automatically creates and configures
                your Cloudflare Pages project:
              </p>

              <ol className="mb-6 list-decimal space-y-3 pl-6 text-gray-600 dark:text-gray-400">
                <li>
                  A new Pages project is created with your repository name
                </li>
                <li>
                  GitHub repository is connected via Cloudflare&apos;s GitHub
                  integration
                </li>
              ...
              <ul className="mb-4 list-disc space-y-2 pl-6 text-gray-600 dark:text-gray-400">
                ...
                <li>
                  <strong>Preview URLs:</strong> Unique URL for each commit
                </li>
                <li>
                  <strong>Branch Deployments:</strong> Deploy previews for all
                  branches
                </li>
                <li>
                  <strong>Global CDN:</strong> Automatic edge caching worldwide
                </li>
              </ul>
              ...
              <div className="my-6 rounded-lg border-2 border-dashed border-gray-300 bg-gray-100 p-8 text-center dark:border-gray-700 dark:bg-gray-800">
                <div className="text-gray-500 dark:text-gray-400">
                  ...
                  <p className="text-sm">
                    Screenshot: Cloudflare Pages dashboard showing new Hugo
                    project
                  </p>
                </div>
              </div>
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <ol className="mb-6 list-decimal space-y-4 pl-6 text-gray-600 dark:text-gray-400">
                <li>
                  ...
                  <p className="mt-1">
                    In Cloudflare dashboard, navigate to Pages &gt; Your Project
                    &gt; Custom domains
                  </p>
                </li>
                <li>
                  ...
                  <p className="mt-1">
                    Click &quot;Set up a custom domain&quot; and enter your
                    domain
                  </p>
                </li>
                <li>
                  ...
                  <p className="mt-1">
                    Cloudflare provides options based on where your DNS is
                    hosted:
                  </p>
                </li>
              </ol>
              ...
              <h3 className="mt-6 mb-3 text-xl font-semibold">
                Option A: Domain on Cloudflare DNS
              </h3>
              <p className="mb-4 text-gray-600 dark:text-gray-400">
              ...
              <h3 className="mt-6 mb-3 text-xl font-semibold">
                Option B: Domain on External DNS
              </h3>
              <p className="mb-4 text-gray-600 dark:text-gray-400">
              ...
              <div className="my-6 rounded-lg border-2 border-dashed border-gray-300 bg-gray-100 p-8 text-center dark:border-gray-700 dark:bg-gray-800">
                <div className="text-gray-500 dark:text-gray-400">
                  ...
                  <p className="text-sm">
                    Screenshot: Cloudflare Pages custom domain configuration
                  </p>
                </div>
              </div>
            </div>
          ...
          <section id="cloudflare-dns" className="mb-12">
            ...
            <div className="prose dark:prose-invert max-w-none">
              <p className="mb-4 text-gray-600 dark:text-gray-400">
                Using Cloudflare DNS provides additional benefits for your Pages
                project:
              </p>
              ...
              <ul className="mb-4 list-disc space-y-2 pl-6 text-gray-600 dark:text-gray-400">
                <li>
                  <strong>Automatic SSL:</strong> Instant certificate
                  provisioning
                </li>
                <li>
                  <strong>DDoS Protection:</strong> Enterprise-grade protection
                  included
                </li>
                <li>
                  <strong>Analytics:</strong> Detailed traffic and performance
                  insights
                </li>
                <li>
                  <strong>Edge Caching:</strong> Optimized caching rules
                </li>
                <li>
                  <strong>Page Rules:</strong> Custom redirect and caching rules
                </li>
              </ul>
              ...
              <ul className="mb-4 list-disc space-y-2 pl-6 text-gray-600 dark:text-gray-400">
                <li>
                  <strong>Proxy status:</strong> Proxied (orange cloud) for CDN
                  benefits
                </li>
                <li>
                  <strong>SSL/TLS:</strong> Full (strict) mode
                </li>
                <li>
                  <strong>Always Use HTTPS:</strong> Enabled
                </li>
                <li>
                  <strong>Auto Minify:</strong> Enable for HTML, CSS, JS
                </li>
              </ul>

              <div className="rounded-lg border border-yellow-200 bg-yellow-50 p-4 dark:border-yellow-900 dark:bg-yellow-900/20">
                <p className="text-sm text-yellow-800 dark:text-yellow-200">
                  <strong>Note:</strong> If using Cloudflare DNS, make sure the
                  CNAME record for your Pages domain is set to
                  &quot;Proxied&quot; (orange cloud) to get full CDN and
                  security benefits.
                </p>
              </div>
            </div>
          ...
          <section id="troubleshooting" className="mb-12">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <ul className="list-disc space-y-1 pl-6 text-sm text-gray-600 dark:text-gray-400">
                  <li>
                    Set SSL/TLS mode to &quot;Full&quot; or &quot;Full
                    (strict)&quot;
                  </li>
              ...
              <div>
                ...
                <ul className="list-disc space-y-1 pl-6 text-sm text-gray-600 dark:text-gray-400">
                  ...
                  <li>
                    Check that you have a Cloudflare account with Pages access
                  </li>
