      ...
      <main className="flex-1 overflow-y-auto">
        <div className="container mx-auto max-w-4xl px-4 py-12">
          ...
          <p className="mb-8 text-lg text-gray-600 dark:text-gray-400">
            Deploy your Hugo blog to Netlify with forms, functions, and powerful
            build features.
          </p>
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <ol className="mb-6 list-decimal space-y-4 pl-6 text-gray-600 dark:text-gray-400">
                ...
                <li>
                  ...
                  <p className="mt-1">
                    You&apos;ll be redirected to Netlify&apos;s authorization
                    page.
                  </p>
                </li>
                <li>
                ...
                <li>
                  ...
                  <p className="mt-1">
                    You&apos;ll be redirected back with Netlify connected.
                  </p>
                </li>
              </ol>
              ...
              <div className="my-6 rounded-lg border-2 border-dashed border-gray-300 bg-gray-100 p-8 text-center dark:border-gray-700 dark:bg-gray-800">
                <div className="text-gray-500 dark:text-gray-400">
                  ...
                  <p className="text-sm">
                    Screenshot: Netlify OAuth authorization screen
                  </p>
                </div>
              </div>
              ...
              <div className="rounded-lg border border-blue-200 bg-blue-50 p-4 dark:border-blue-900 dark:bg-blue-900/20">
                <p className="text-sm text-blue-800 dark:text-blue-200">
                  ...
                  permission to create sites, trigger builds, and manage domains
          ...
          <section id="auto-creation" className="mb-12">
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <ul className="mb-4 list-disc space-y-2 pl-6 text-gray-600 dark:text-gray-400">
                ...
                <li>
                  <strong>Git Integration:</strong> Auto-deploy on push to main
                  branch
                </li>
                <li>
                  <strong>Deploy Previews:</strong> Preview URLs for pull
                  requests
                </li>
                <li>
                  <strong>Build Logs:</strong> Detailed logs for every
                  deployment
                </li>
              </ul>
              ...
              <div className="my-6 rounded-lg border-2 border-dashed border-gray-300 bg-gray-100 p-8 text-center dark:border-gray-700 dark:bg-gray-800">
                <div className="text-gray-500 dark:text-gray-400">
                  ...
                  <p className="text-sm">
                    Screenshot: Netlify dashboard showing newly created Hugo
                    site
                  </p>
                </div>
              </div>
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <ol className="mb-6 list-decimal space-y-4 pl-6 text-gray-600 dark:text-gray-400">
                <li>
                  ...
                  <p className="mt-1">
                    In Netlify dashboard, navigate to your site &gt; Domain
                    settings
                  </p>
                </li>
                <li>
                ...
                <li>
                  ...
                  <p className="mt-1">
                    Netlify provisions free SSL certificates automatically via
                    Let&apos;s Encrypt
                  </p>
                </li>
              </ol>
              ...
              <h3 className="mt-6 mb-3 text-xl font-semibold">
                Netlify DNS (Optional)
              </h3>
              <p className="mb-4 text-gray-600 dark:text-gray-400">
                For the best performance and automatic SSL, consider using
                Netlify DNS:
              </p>
              ...
              <div className="my-6 rounded-lg border-2 border-dashed border-gray-300 bg-gray-100 p-8 text-center dark:border-gray-700 dark:bg-gray-800">
                <div className="text-gray-500 dark:text-gray-400">
                  ...
                  <p className="text-sm">
                    Screenshot: Netlify domain settings with custom domain
                    configured
                  </p>
                </div>
              </div>
          ...
          <section id="build-settings" className="mb-12">
            ...
            <div className="prose dark:prose-invert max-w-none">
              <p className="mb-4 text-gray-600 dark:text-gray-400">
                StaticPress configures optimal build settings automatically, but
            ...
            <div className="space-y-6">
              <div>
                <h3 className="mb-2 font-semibold">
                  Build Failed: Hugo Version Mismatch
                </h3>
              ...
              <div>
                ...
                <ul className="list-disc space-y-1 pl-6 text-sm text-gray-600 dark:text-gray-400">
                  <li>
                    Ensure theme is a git submodule (not just copied files)
                  </li>
                  <li>
                    Check{" "}
                    <code className="rounded bg-gray-200 px-1 dark:bg-gray-700">
                  ...
                  <li>
                    Verify theme directory name matches{" "}
                    <code className="rounded bg-gray-200 px-1 dark:bg-gray-700">
                      hugo.toml
                    </code>{" "}
                    config
              ...
              <div>
                ...
                <ul className="list-disc space-y-1 pl-6 text-sm text-gray-600 dark:text-gray-400">
                  ...
                  <li>
                    Try clicking &quot;Verify DNS configuration&quot; in Domain
                    settings
                  </li>
              ...
              <div>
                ...
                <ul className="list-disc space-y-1 pl-6 text-sm text-gray-600 dark:text-gray-400">
                  ...
                  <li>
                    Use Hugo&apos;s image processing instead of external tools
                  </li>
                  <li>
                    Consider using{" "}
                    <code className="rounded bg-gray-200 px-1 dark:bg-gray-700">
