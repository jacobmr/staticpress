      ...
      <main className="flex-1 overflow-y-auto">
        <div className="container mx-auto max-w-4xl px-4 py-12">
          ...
          <section id="service-description" className="mb-12">
            ...
            <div className="prose dark:prose-invert max-w-none">
              <p className="mb-4 text-gray-600 dark:text-gray-400">
                StaticPress is a web-based WYSIWYG editor for Hugo and Krems
                static site blogs with GitHub integration. The service allows
                you to:
              </p>
              <ul className="mb-4 list-disc space-y-2 pl-6 text-gray-600 dark:text-gray-400">
                <li>
                  Authenticate via GitHub OAuth and connect your repositories
                </li>
              ...
              <p className="mb-4 text-gray-600 dark:text-gray-400">
                StaticPress acts as an interface to your GitHub repository. Your
                content is stored in your own GitHub account, not on our
                servers.
              </p>
            </div>
          </section>
          ...
          <section id="account-terms" className="mb-12">
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <p className="mb-4 text-gray-600 dark:text-gray-400">
                Each user may only maintain one free account. Paid accounts may
          ...
          <section id="user-responsibilities" className="mb-12">
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <ul className="mb-4 list-disc space-y-2 pl-6 text-gray-600 dark:text-gray-400">
                ...
                <li>
                  Ensure you have the right to publish any content you create
                </li>
                ...
                <li>
                  Not attempt to gain unauthorized access to other systems
                </li>
                <li>Not interfere with or disrupt the service</li>
                <li>
                  Comply with GitHub&apos;s Terms of Service when using
          ...
          <section id="subscriptions" className="mb-12">
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <p className="mb-4 text-gray-600 dark:text-gray-400">
                The free tier includes limited access to features. Free tier
                users can edit their 5 most recent posts and do not have access
                to image uploads.
              </p>
              ...
              <p className="mb-4 text-gray-600 dark:text-gray-400">
                Paid subscriptions (Personal, SMB, Pro) are billed monthly or
                annually, depending on your selection. All prices are in USD.
              </p>
              <ul className="mb-4 list-disc space-y-2 pl-6 text-gray-600 dark:text-gray-400">
                <li>
                  <strong>Personal:</strong> $2.50/month or $20/year
                </li>
                <li>
                  <strong>SMB:</strong> $5/month or $50/year
                </li>
                <li>
                  <strong>Pro:</strong> $10/month or $100/year
                </li>
              </ul>
              ...
              <p className="mb-4 text-gray-600 dark:text-gray-400">
                If a payment fails, we will attempt to charge your payment
                method again. If payment continues to fail, your subscription
          ...
          <section id="intellectual-property" className="mb-12">
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <p className="mb-4 text-gray-600 dark:text-gray-400">
                ...
                StaticPress. Your blog posts, images, and other content belong
                to you and are stored in your own GitHub repository. We claim no
              ...
              <p className="mb-4 text-gray-600 dark:text-gray-400">
                By using StaticPress, you grant us a limited license to access,
                process, and display your content solely for the purpose of
                providing the service to you. This license ends when you delete
                your account or disconnect your repository.
              </p>

              <h3 className="mt-6 mb-3 text-xl font-semibold">
                StaticPress Property
              </h3>
              <p className="mb-4 text-gray-600 dark:text-gray-400">
                StaticPress and its original content, features, and
                functionality are owned by StaticPress and are protected by
              ...
              <p className="mb-4 text-gray-600 dark:text-gray-400">
                If you provide feedback or suggestions about StaticPress, we may
                use this feedback without any obligation to you.
              </p>
            </div>
          </section>
          ...
          <section id="prohibited-uses" className="mb-12">
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <ul className="mb-4 list-disc space-y-2 pl-6 text-gray-600 dark:text-gray-400">
                <li>
                  Publish illegal, harmful, threatening, abusive, or harassing
                  content
                </li>
                ...
                <li>
                  Collect personal information from others without consent
                </li>
                <li>Interfere with the operation of the service</li>
                <li>Attempt to bypass any security measures</li>
                <li>
                  Use the service for any commercial purpose without a paid
                  subscription
                </li>
                <li>
              ...
              <p className="mb-4 text-gray-600 dark:text-gray-400">
                Violation of these prohibited uses may result in immediate
          ...
          <section id="service-availability" className="mb-12">
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <p className="mb-4 text-gray-600 dark:text-gray-400">
                StaticPress depends on third-party services (GitHub, Stripe,
                etc.). We are not responsible for outages or issues caused by
          ...
          <section id="limitation-liability" className="mb-12">
            ...
            <div className="prose dark:prose-invert max-w-none">
              <p className="mb-4 text-gray-600 dark:text-gray-400">
                TO THE MAXIMUM EXTENT PERMITTED BY LAW, STATICPRESS AND ITS
          ...
          <section id="indemnification" className="mb-12">
            ...
            <div className="prose dark:prose-invert max-w-none">
              <p className="mb-4 text-gray-600 dark:text-gray-400">
                You agree to indemnify, defend, and hold harmless StaticPress
          ...
          <section id="termination" className="mb-12">
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <ul className="mb-4 list-disc space-y-2 pl-6 text-gray-600 dark:text-gray-400">
                ...
                <li>
                  Your account data will be deleted according to our Privacy
                  Policy
                </li>
              ...
              <p className="mb-4 text-gray-600 dark:text-gray-400">
                ...
                cases of serious violation where immediate action is required.
              </p>
              ...
              <p className="mb-4 text-gray-600 dark:text-gray-400">
                ...
                survive, including intellectual property, limitation of
          ...
          <section id="governing-law" className="mb-12">
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <p className="mb-4 text-gray-600 dark:text-gray-400">
                ...
                the rules of the American Arbitration Association. You agree to
                waive your right to a jury trial and to participate in class
                actions.
              </p>
              <p className="mb-4 text-gray-600 dark:text-gray-400">
          ...
          <section id="changes" className="mb-12">
            ...
            <div className="prose dark:prose-invert max-w-none">
              <p className="mb-4 text-gray-600 dark:text-gray-400">
                ...
                provide notice of significant changes by:
              </p>
              <ul className="mb-4 list-disc space-y-2 pl-6 text-gray-600 dark:text-gray-400">
            ...
            <div className="prose dark:prose-invert max-w-none">
              <ul className="mb-4 list-disc space-y-2 pl-6 text-gray-600 dark:text-gray-400">
                <li>
                  ...
                  entire agreement between you and StaticPress.
                </li>
                <li>
                ...
                <li>
                  ...
                  without our consent. We may assign our rights at any time.
                </li>
              </ul>
            </div>
          </section>
          ...
          >
            ...
            <p className="text-gray-600 dark:text-gray-400">
              <a
                href="mailto:legal@staticpress.me"
                className="text-blue-600 hover:underline"
              >
