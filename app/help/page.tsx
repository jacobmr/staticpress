        ...
        <div className="container mx-auto max-w-4xl px-4 py-12">
          ...
          <nav className="mb-12 rounded-lg border border-gray-200 bg-gray-50 p-6 dark:border-gray-800 dark:bg-gray-900">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <a href="#deployment" className="text-blue-600 hover:underline">
                  Deployment
                </a>
              </li>
              <li>
          ...
          <section id="getting-started" className="mb-12">
            ...
            <div className="prose dark:prose-invert max-w-none">
              <p className="mb-4 text-gray-600 dark:text-gray-400">
                StaticPress is a WYSIWYG editor for Hugo static site blogs. It
                connects to your GitHub repository and lets you create and edit
                posts through a clean, visual interface.
              </p>

              <h3 className="mt-6 mb-3 text-xl font-semibold">
                Option 1: Create a New Blog
              </h3>
              <ol className="mb-4 list-decimal space-y-2 pl-6 text-gray-600 dark:text-gray-400">
                ...
                <li>
                  StaticPress creates a GitHub repository with Hugo
                  pre-configured
                </li>
                <li>Start writing!</li>
              </ol>
              ...
              <h3 className="mt-6 mb-3 text-xl font-semibold">
                Option 2: Connect Existing Blog
              </h3>
              <ol className="mb-4 list-decimal space-y-2 pl-6 text-gray-600 dark:text-gray-400">
                <li>Sign in with GitHub</li>
          ...
          <section id="creating-posts" className="mb-12">
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <ol className="mb-4 list-decimal space-y-2 pl-6 text-gray-600 dark:text-gray-400">
                ...
                <li>
                  Click &quot;Publish&quot; to make it live, or &quot;Save
              ...
              <p className="mb-4 text-gray-600 dark:text-gray-400">
                Click on any post in the sidebar to load it into the editor.
                Make your changes and click &quot;Publish&quot; to update the
                post on your site.
              </p>
              ...
              <p className="mb-4 text-gray-600 dark:text-gray-400">
                Hover over a post in the sidebar and click the delete icon.
                Confirm the deletion when prompted. This removes the post from
          ...
          <section id="editor-features" className="mb-12">
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <ul className="mb-4 list-disc space-y-2 pl-6 text-gray-600 dark:text-gray-400">
                ...
                <li>
                  Or paste an image directly from your clipboard (Ctrl/Cmd+V)
                </li>
                <li>
          ...
          <section id="deployment" className="mb-12">
            ...
            <div className="prose dark:prose-invert max-w-none">
              <p className="mb-4 text-gray-600 dark:text-gray-400">
                Your Hugo blog can be deployed to various platforms. Here are
            ...
            <div className="space-y-6">
              <div>
                <h3 className="mb-2 font-semibold">
                  How does StaticPress work?
                </h3>
                <p className="text-gray-600 dark:text-gray-400">
                  StaticPress connects to your GitHub repository and uses the
                  GitHub API to read and write Markdown files. When you publish
                  a post, it commits the file to your repo, which triggers your
                  site to rebuild.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  Yes. We use GitHub OAuth for authentication and only request
                  the permissions needed to read and write to your repositories.
                  Your posts are stored in your own GitHub repository.
                </p>
              </div>

              <div>
                <h3 className="mb-2 font-semibold">
                  Can I use StaticPress with an existing Hugo blog?
                </h3>
                <p className="text-gray-600 dark:text-gray-400">
                  Absolutely! Select &quot;Connect Existing Blog&quot; on the
                  setup page and choose your repository. Make sure to set the
                  correct content path for where your posts are stored.
                </p>
              </div>

              <div>
                <h3 className="mb-2 font-semibold">
                  What Hugo themes are supported?
                </h3>
                <p className="text-gray-600 dark:text-gray-400">
                  StaticPress works with any Hugo theme. The editor creates
                  standard Markdown files with YAML frontmatter that Hugo
                  expects.
                </p>
              </div>
              ...
              <div>
                <h3 className="mb-2 font-semibold">
                  How do I change my blog&apos;s theme or settings?
                </h3>
                <p className="text-gray-600 dark:text-gray-400">
                  Edit the hugo.toml file in your repository directly on GitHub,
                  or clone the repo locally and make changes there. StaticPress
                  focuses on post editing.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  Yes, you can cancel anytime from the Pricing page. You&apos;ll
          ...
          <section className="rounded-lg border border-gray-200 bg-gray-50 p-6 dark:border-gray-800 dark:bg-gray-900">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              ...
              <a
                href="mailto:support@staticpress.me"
                className="text-blue-600 hover:underline"
              >
