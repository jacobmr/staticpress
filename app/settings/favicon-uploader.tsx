  ...
  const handleUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      if (file.size > 500 * 1024) {
        throw new Error(
          "File too large. Favicon should be under 500KB. Try using favicon.io to generate optimized icons.",
        );
      }
      ...
      if (!response.ok) {
        ...
        if (contentType?.includes("application/json")) {
          ...
          if (
            ...
            throw new Error(
              "File too large. Try a smaller image or use favicon.io to generate optimized icons.",
            );
          }
      ...
      console.error(error);
      const errorMessage =
        error instanceof Error ? error.message : "Error uploading favicon";
