        ...
        <div className="container mx-auto max-w-4xl px-4 py-12">
          ...
          <section id="information-collected" className="mb-12">
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <p className="mb-4 text-gray-600 dark:text-gray-400">
                When you sign in with GitHub, we collect the following
              ...
              <ul className="mb-4 list-disc space-y-2 pl-6 text-gray-600 dark:text-gray-400">
                ...
                <li>
                  OAuth access token (used to access your repositories on your
                  behalf)
                </li>
              </ul>
              ...
              <ul className="mb-4 list-disc space-y-2 pl-6 text-gray-600 dark:text-gray-400">
                ...
                <li>
                  Analytics events (e.g., repository connected, post published)
                </li>
              ...
              <p className="mb-4 text-gray-600 dark:text-gray-400">
                If you subscribe to a paid plan, payment information is
                collected and processed by Stripe. We store only your Stripe
                customer ID and subscription ID, not your payment card details.
              </p>
            </div>
          </section>
          ...
          <section id="how-we-use" className="mb-12">
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <ul className="mb-4 list-disc space-y-2 pl-6 text-gray-600 dark:text-gray-400">
                ...
                <li>
                  Access your GitHub repositories to read and write blog posts
                </li>
          ...
          <section id="third-party-services" className="mb-12">
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <p className="mb-4 text-gray-600 dark:text-gray-400">
                ...
                connect your account, you authorize us to read and write to your
                repositories. GitHub&apos;s privacy policy applies to
                information stored in your repositories.
              </p>

              <h3 className="mt-6 mb-3 text-xl font-semibold">Stripe</h3>
              <p className="mb-4 text-gray-600 dark:text-gray-400">
                We use Stripe for payment processing. Stripe collects and
                processes your payment information according to their privacy
                policy. We do not store your credit card numbers or bank account
                details.
              </p>

              <h3 className="mt-6 mb-3 text-xl font-semibold">Supabase</h3>
              <p className="mb-4 text-gray-600 dark:text-gray-400">
                We use Supabase as our database provider to store user accounts,
                repository configurations, and usage data. Data is stored
                securely with encryption at rest.
              </p>
              ...
              <p className="mb-4 text-gray-600 dark:text-gray-400">
                Your blog may be deployed to platforms like GitHub Pages,
                Cloudflare Pages, Vercel, or Netlify. These platforms have their
                own privacy policies that govern how they handle your site
                content.
              </p>
            </div>
          </section>
          ...
          <section id="data-storage" className="mb-12">
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <ul className="mb-4 list-disc space-y-2 pl-6 text-gray-600 dark:text-gray-400">
                ...
                <li>
                  OAuth tokens are stored securely and used only for authorized
                  operations
                </li>
              ...
              <p className="mb-4 text-gray-600 dark:text-gray-400">
                Your blog content is stored in your own GitHub repository, not
                on our servers. We only access your content when you actively
                use the editor.
              </p>
            </div>
          </section>
          ...
          <section id="cookies" className="mb-12">
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <p className="mb-4 text-gray-600 dark:text-gray-400">
                You can clear local storage through your browser settings at any
                time.
              </p>
            </div>
          </section>
          ...
          <section id="user-rights" className="mb-12">
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <p className="mb-4 text-gray-600 dark:text-gray-400">
                Your profile information syncs from GitHub. To update it, change
              ...
              <p className="mb-4 text-gray-600 dark:text-gray-400">
                Note: Your blog content remains in your GitHub repository as you
                own that data.
              </p>

              <h3 className="mt-6 mb-3 text-xl font-semibold">Revoke Access</h3>
              <p className="mb-4 text-gray-600 dark:text-gray-400">
                You can revoke StaticPress&apos;s access to your GitHub account
                at any time through your GitHub settings under Applications &gt;
              ...
              <p className="mb-4 text-gray-600 dark:text-gray-400">
                Your blog content is already portable as it lives in your GitHub
                repository in standard Markdown format.
              </p>
            </div>
          </section>
          ...
          <section id="data-retention" className="mb-12">
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <ul className="mb-4 list-disc space-y-2 pl-6 text-gray-600 dark:text-gray-400">
                ...
                <li>
                  <strong>Usage data:</strong> Retained for 12 months for
                  analytics purposes
                </li>
                <li>
                ...
                <li>
                  <strong>Server logs:</strong> Retained for 30 days for
                  security and debugging
                </li>
              </ul>
              <p className="mb-4 text-gray-600 dark:text-gray-400">
                After account deletion, we may retain certain data in anonymized
                form for analytics.
              </p>
            </div>
          </section>
          ...
          <section id="children" className="mb-12">
            ...
            <div className="prose dark:prose-invert max-w-none">
              <p className="mb-4 text-gray-600 dark:text-gray-400">
                StaticPress is not intended for children under 13 years of age.
          ...
          >
            ...
            <p className="text-gray-600 dark:text-gray-400">
              <a
                href="mailto:privacy@staticpress.me"
                className="text-blue-600 hover:underline"
              >
